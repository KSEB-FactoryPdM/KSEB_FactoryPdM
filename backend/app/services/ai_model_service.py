...
class AIModelService:
    ...
    def preprocess_sensor_data(self, sensor_data: Dict[str, Any]) -> Optional[float]:
        ...
        try:
            ...
            # 센서별 정규화 범위 (실제로는 훈련 데이터 통계 사용)
            normalization_ranges = {
                'TEMP_A001': (0, 120), 'PRES_A001': (0, 10), 'VIB_A001': (0, 50),
                'TEMP_M001': (0, 130), 'CURR_M001': (0, 100), 'RPM_M001': (0, 3000),
                'FLOW_P001': (0, 1000), 'PRES_P001': (0, 15),
                'POS_V001': (0, 100), 'SPEED_C001': (0, 100)
            }
            
            min_val, max_val = normalization_ranges.get(sensor_id, (0, 100))
